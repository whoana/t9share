...
public class MonitorController {
	...
	@RequestMapping(value = "/trace/managers/monitors/operations", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/monitors/system-resource", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/monitors/tps1", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/managers/monitors/tps2", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
