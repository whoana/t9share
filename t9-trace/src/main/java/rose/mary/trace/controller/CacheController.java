...
public class CacheController {
	...
	@RequestMapping(value = "/trace/managers/caches", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	public @ResponseBody ComMessage<?, Map> getCacheInfo(
		...
		try {
			...
			// }
			//
			// List<CacheProxy<String, BotEvent>> botEventCaches =
			// cacheManager.getBotEventCaches();
	...
	@RequestMapping(value = "/trace/managers/caches/{cacheName}", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
