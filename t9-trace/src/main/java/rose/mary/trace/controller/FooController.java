...
public class FooController {
	...
	@RequestMapping(value = "/trace/services/foos", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
	...
	@RequestMapping(value = "/trace/services/foos/insert", params = "method=GET", method = RequestMethod.POST, headers = "content-type=application/json")
