...
public class ConfigurationController {
	...
	@CrossOrigin
	@RequestMapping(value = "/admin/console/configs", method = RequestMethod.GET, headers = "content-type=application/json")
	...
	@CrossOrigin
	@RequestMapping(value = "/admin/console/configs", method = RequestMethod.PUT, headers = "content-type=application/json")
	 ...
	 * @throws Exception
	 */
	public synchronized void setInterfaceCacheManagerConfig(InterfaceCacheManagerConfig interfaceCacheManagerConfig)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public synchronized void setTraceErrorHandlerManagerConfig(
			TraceErrorHandlerManagerConfig traceErrorHandlerManagerConfig) throws Exception {
