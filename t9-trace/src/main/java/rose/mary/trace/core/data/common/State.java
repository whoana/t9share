...
public class State implements Serializable {
	...
	public int getFinishSenderCount() {
		return finishSenderCount;
	}

	public void setFinishSenderCount(int finishSenderCount) {
		this.finishSenderCount = finishSenderCount;
	}

	public void setBackendLog(String backendLog) {
		this.backendLog = backendLog;
	}

	public String getBackendLog() {
		return backendLog;
	}
